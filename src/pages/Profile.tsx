...
const Profile = () => {
  ...
  console.log(userContext?.profile?.avatar_url);
  console.log(user);
  ...
  return (
    <>
      <div className="flex justify-center h-screen w-full w-max-sm">
        <section className="flex flex-col justify-center items-center h-screen w-full max-w-sm bg-gray-100 relative shadow-xl">
          <header>
            ...
            {avatarUrl ? (
              <img
                alt="User Avatar"
                src={avatarUrl}
                className="inline-block h-20 w-20 rounded-full cursor-pointer object-cover object-center"
              />
            ) : (
          ...
          <section className="flex flex-col justify-center w-full w-max-sm">
            <label className="mt-4 mb-2 text-bold font-Inter">
              <strong>About me</strong>
              <span className="font-Inter flex">
                ...
                bear claw donut macaroon cupcake. Read More
              </span>
            </label>
          </section>
          ...
          <section className="flex flex-col">
            ...
            <button
              ...
              disabled={isDeleting}
              className={`uppercase bg-primary text-white font-Inter text-normal rounded-lg shadow-lg px-24 py-4 w-full flex justify-between mb-4 ${
                isDeleting ? "bg-red-700" : "bg-amber-400"
              }`}
            >
