...
//               />
//               <h2 className="text-2xl font-bold mb-4 font-Inter flex">
...
const Profile = () => {
  ...
  return (
    <>
      <div className="flex justify-center h-screen pb-24">
        {" "}
        {/* Add padding bottom to avoid overlap */}
        <section className="flex flex-col justify-center items-center h-full w-full max-w-sm bg-gray-100 relative shadow-xl">
          <header>
            <div className="flex items-center">
              <img
                src="/src/assets/img/Logo.png"
